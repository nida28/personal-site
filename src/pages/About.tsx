            ...
            <div className="relative">
              ...
              <div className="clear-both mt-8">
                ...
                <div className={`${textConfig.text.base} ${textConfig.text.size} text-black dark:text-white space-y-6 leading-relaxed text-justify`}>
                  ...
                  <p>
                    I started out dabbling in journalism, but an internship quickly showed me it wasn't the right path for me. Creighton's Journalism <a href="https://www.creighton.edu/arts-sciences/computersciencedesignjournalism" target="_blank" rel="noopener noreferrer" className="text-cyan-600 dark:text-cyan-400 hover:underline">department</a> which led me to take a web design class during my sophomore year. I wrote my very first line of code at 20 – and found programming both challenging and invigorating. Around that time, the tech industry was booming – so my eventual decision to double major in Computer Science and Graphic Design, while driven by curiosity, was also partly strategic.
                  </p>
                  <p>
                  ...
                  <p>Today, I live in Charlottenburg with my two cats –  Richie and Osi –  who are father and son. I enjoy baking, reading (mostly nonfiction but some fiction too), and I have a longstanding daily ritual of watching one TV show episode while having lunch. From time to time, I explore the city through cafés, pâtisseries, and parks. I sometimes attend meetups that interest me, and I'm a regular at the Berlin Zoo; the <a href="https://www.zootier-lexikon.org/saeugetiere-mammalia/spitzhoernchen-halbaffen-und-affen/gibbons-und-menschenaffen-hominoidea/siamang#zoo" target="_blank" rel="noopener noreferrer" className="text-cyan-600 dark:text-cyan-400 hover:underline">Siamang</a> pair in the monkey enclosure have my heart. Watching them swing feels like a spiritual experience to me –  I can't explain it.</p>
                  <p>While my career path shifted toward tech, I never really stopped caring about the law. Over the years I've watched courtroom dramas, legal thrillers, and procedural shows (feel free to send your favorites!) – perhaps as a way to stay connected to that part of myself who really wanted to be involved in the legal field. And in 2025, things came full circle when I discovered the University of London's part-time <a href="https://www.london.ac.uk/study/courses/undergraduate/llb-bachelor-laws" target="_blank" rel="noopener noreferrer" className="text-cyan-600 dark:text-cyan-400 hover:underline">LLB program</a>, and I enrolled. I don't know how exactly it fits into the bigger picture; I don't have a five-year plan for it. I just knew the longing hadn't gone away –  and sometimes, that's enough of a reason to begin. </p>
              ...
              <div className="mt-12 mb-20">
                ...
                <div className="space-y-4">
                  <FAQItem
                    question="Why Omaha of all places? How did you find it?"
                    answer={<>I closed my eyes and pointed at a random state on a U.S. map 😜 <br /> Honestly? I didn't arrive in Omaha with expectations – just layers (not nearly enough). That first winter hit hard: subzero temperatures, grey skies, homesickness, and a perpetual sense of being lost. But I was also incredibly lucky to meet friends – and their families – who welcomed me with open arms, went out of their way to make my life more comfortable, and helped me build a sense of home in a place that was as far from Mauritius as you could possibly get. <a href="https://furthestcity.com/city/LINCOLN_NE_UNITED_STATES_OF_AMERICA" target="_blank" rel="noopener noreferrer" className="text-cyan-600 dark:text-cyan-400 hover:underline">No, really.</a> <br />
                      It really couldn't have been a more unexpected – or better – landing spot. Despite the initial adjustment, I look back on those years with deep gratitude. Omaha and Lincoln will always hold a special place in my heart.</>}
                  />
                  <FAQItem
                    question="Why leave the U.S.? Why Germany? Which one is better?"
                    answer={<>I didn't really "leave" the U.S. so much as I followed a(nother) whim. I'd always wanted to live in Europe – having almost studied in the U.K. – so when I joined a company that had a branch in Berlin, I took it as a chance to explore. <br />
                      That was in 2020 – right in the middle of COVID, when lots of people were making drastic life choices anyway 😄 <br />As for which country is "better" – I don't think there's a universal answer. Each country has its own pros and cons, and the right place depends on your values, priorities, and where you are in life. I'm incredibly grateful for everything I gained in the U.S., and I haven't entirely ruled out going back someday. <br />But for now, Berlin makes the most sense for me.
                  ...
                  <FAQItem
                    ...
                    answer={<>Yep. Trust me, I know. <br />But as Rebecca Bunch from my all-time favorite show <a href="https://www.youtube.com/watch?v=qzY3EaJTuJk&ab_channel=racheldoesstuff" target="_blank" rel="noopener noreferrer" className="text-cyan-600 dark:text-cyan-400 hover:underline">Crazy Ex-Girlfriend</a> would say... the situation's a lot more nuanced than that.<br /> Like many Mauritians, I went abroad for university, partly because higher education options back home are limited – though now this is rapidly changing – and partly because there’s real value in stepping outside a small island to explore the world, learn from other cultures, and grow in ways you simply can’t by staying in one place your whole life. <br />That said, returning isn’t always simple. The job market in Mauritius is limited, and many of us end up building our lives elsewhere, not out of rejection of home, but because opportunity often lives somewhere else. <br />That said, it’s still tough being away from home. I miss my large extended family, but also the food, the sea, the pace of life, the sense of belonging that can only come from your origins — even when I’ve adjusted to life elsewhere. I don’t have fixed long-term plans right now, but one thing I know for sure: staying connected to Mauritius — and being able to return easily and often — will always be a priority for me.</>}
                  />
