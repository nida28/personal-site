          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center lg:justify-start mb-8">
              <div className="relative">
                <div className="w-48 h-48 rounded-3xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 dark:from-blue-500/30 dark:to-purple-500/30 flex items-center justify-center border border-gray-200 dark:border-white/10">
                ...
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/30 to-purple-500/30 rounded-3xl blur opacity-30"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {skills.map((skill, index) => (
                  <div
                    key={skill}
                    className="group relative bg-white/80 dark:bg-slate-700/50 backdrop-blur-sm rounded-2xl px-6 py-4 text-center shadow-sm border border-gray-100 dark:border-white/10 hover:shadow-xl hover:shadow-blue-500/10 dark:hover:shadow-blue-500/20 transition-all duration-500 hover:scale-[1.02] hover:border-blue-200/50 dark:hover:border-blue-400/30"
                    style={{ animationDelay: `${index * 50}ms` }}
                  >
                    <span className="text-gray-800 dark:text-gray-200 font-medium tracking-wide group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                      {skill}
                    </span>
