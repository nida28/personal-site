...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-blue-50/40 to-blue-50/30 dark:from-blue-900 dark:via-indigo-900 dark:to-purple-900 text-gray-700 dark:text-white relative overflow-hidden">
      {/* Dark mode background - dark blue to dark purple gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 dark:block hidden"></div>
        ...
        <div className="animate-fade-in space-y-12">
          <div className="space-y-8">
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-light tracking-tight leading-[0.85]">
              ...
              <span className="bg-gradient-to-r from-blue-400 via-blue-600 to-blue-800 dark:from-pink-400 dark:via-fuchsia-500 dark:to-purple-600 bg-clip-text text-transparent font-normal block">
                Nidaa
              </span>
            </h1>
